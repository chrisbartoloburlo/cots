 ...
 */
package examples.petclinic.api

import examples.petclinic.model.Owner
import examples.petclinic.model.OwnerFields
import examples.petclinic.model.RestError
import examples.petclinic.core.JsonSupport._
